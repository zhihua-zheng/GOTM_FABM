...
lat = ncread('w50n145w_hr.cdf','lat');
lon = ncread('w50n145w_hr.cdf','lon');
w_u = ncread('w50n145w_hr.cdf','WU_422');
w_v = ncread('w50n145w_hr.cdf','WV_423');
z_wind = -ncread('w50n145w_hr.cdf','depth');
w_dir = -ncread('w50n145w_hr.cdf','WD_410');
w_gust = -ncread('w50n145w_hr.cdf','WG_430');
w_spd = -ncread('w50n145w_hr.cdf','WS_401');
sst = ncread('sst50n145w_hr.cdf','T_25');
sss = ncread('sss50n145w_hr.cdf','S_41');
ssd = ncread('ssd50n145w_hr.cdf','STH_71');
rh = ncread('rh50n145w_hr.cdf','RH_910');
z_rh = -ncread('rh50n145w_hr.cdf','depth');
rain = ncread('rain50n145w_hr.cdf','RN_485');
Rs = ncread('rad50n145w_hr.cdf','RD_495');
Rl = ncread('lw50n145w_hr.cdf','Ql_136');
P = ncread('bp50n145w_hr.cdf','BP_915');
t_air = ncread('airt50n145w_hr.cdf','AT_21');
z_ta = -ncread('airt50n145w_hr.cdf','depth');
time = ncread('rad50n145w_hr.cdf','time'); % hours since 2007 Jun 8 05:00:00
time_rain = ncread('rain50n145w_hr.cdf','time'); % hours since 2007 Jun 8 04:00:00
...
depth_s = ncread('s50n145w_mon.cdf','depth');
sprof = ncread('s50n145w_mon.cdf','S_41');
depth_t = ncread('t50n145w_mon.cdf','depth');
tprof = ncread('t50n145w_mon.cdf','T_20');
...
cur_u = ncread('cur50n145w_mon.cdf','U_320');
cur_v = ncread('cur50n145w_mon.cdf','V_321');
cur_spd = ncread('cur50n145w_mon.cdf','CS_300');
cur_dir = ncread('cur50n145w_mon.cdf','CD_310');
depth_cur = ncread('cur50n145w_mon.cdf','depth');

time_prof = ncread('s50n145w_mon.cdf','time'); % days since 2007 Jun 16 12:00:00
