...
The following topics will be covered in this readme file:
  ...
  1. Deep Temperature Salinity Density and Pressure
...
A deep instrument measuring conductivity, temperature, and pressure
was attached to the acoustic release of OCS moorings starting with 
the 2012 deployments.  Conductivity, temperature and pressure are 
used with UNESCO (1983) equations to compute salinity in Practical
Salinity Units (PSU).  Density is calculated as sigma-4000 at Papa and 
sigma-6000 at KEO, indicating adjustment to the nearest 1000 dbar 
reference pressure.

Due to the homogenous nature of the deep ocean, slight calibration 
differences can overwhelm the natural variability in the measurements.
Pre and post calibrated values were averaged to reduce the variability 
in the spread of the calibrations.  Offsets less than or up to the 
instrument error were added to the conductivity and/or temperature 
time-series to generate a continuous time-series between deployments.

In ascii format files to the right of the data you will find 
quality codes and source codes. All of these codes are 
defined below.
