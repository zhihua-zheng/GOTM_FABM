...
Wind stress vector components are computed from the wind 
stress magnitude T returned from the COARE 3.0b algorithm 
using the following,
...
wind vector components, w is the wind speed and wg is the 
gustiness output from the COARE algorithm. 
