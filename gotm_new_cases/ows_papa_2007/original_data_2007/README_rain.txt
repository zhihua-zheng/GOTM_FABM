...
Precipitation has units of millimeters per hour and is 
measured at a height of 3.5 meters above the sea 
surface. Instrument height is shown as a negative depth 
in data files.

Also included in daily files are time series of standard 
deviation, and percent time raining. 
...
10-minute data (0000, 0010, 0020...). For further 
information see 
