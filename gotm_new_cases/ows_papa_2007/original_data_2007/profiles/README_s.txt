...
525 meters.  Nominal depths, along with these measurements, are 
currently used to compute salinity on all moorings, in units of 
PSU (practical salinity units).  Nominal depth is a good 
approximation of instrument location on a taut line mooring 
(Papa), but actual depth and pressure can vary on a slackline 
mooring (KEO, ARC).  Users are cautioned that salinity 
calculation errors could be introduced by excursions from the 
nominal depths at KEO and ARC. 
